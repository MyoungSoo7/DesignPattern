package com.backend.bakckend.programmers.array;
...
public class SortedArray {
    public static void main(String[] args) {
        ...
        int[] result = sortedArray.solution(genres, plays); // [4, 1, 3, 0]
    ...
    public int[] solution(String[] genres, int[] plays) {
        ...
        System.out.println("genrePlayCount : " + genrePlayCount);
        System.out.println("genreSongs : " + genreSongs);
